...
var MinifyJpegAsync = (function()
{
    ...
    that.minify = function(image, new_size, callback)
    {
        ...
        if (image instanceof ArrayBuffer)
        {
            if (image[0] == 255 && image[1] == 216)
            {
                ...
                var imageStr = "data:image/jpeg;base64," + that.encode64(rawImage);
            }
            else
            {
        ...
        imageObj.onload = function()
        {
            ...
            var resized = that.resize(imageObj, segments, NEW_SIZE);
    ...
    that.resize = function(img, segments, NEW_SIZE)
    {
        ...
        var srcImg = ctx.getImageData(0, 0, width, height);
